<?php
    ...
    if(isset($publication)){
        if(empty($message)){
            include("config.php");
            $req=$pdo->prepare("SELECT titre_livre FROM livre WHERE title=? LIMIT 1");
            ...
            if(count($tab)>0){
                ...
                $ins=$pdo->prepare("INSERT INTO livre(NULL,NULL,titre_livre,categorie,document) VALUE(?,?,?)");
...
<html lang="en">
    ...
    <body>
        ...
        <div class="card">
            ...
            <form action="livre.php" method="GET" enctype="multipart/form-data">
